...
function goRegisterPage () {
    location.href = window.isLogin ? 'http://console.cloud.inspur.com/' : 'http://login.cloud.inspur.com/register';
}
function goLoginPage () {
    location.href = (isProduction ? 'http://login.cloud.inspur.com/login' : 'http://login.cloud.inspur.com/login') + '?service=' + encodeURIComponent(location.href);
}
